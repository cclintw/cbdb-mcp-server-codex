...
def write_html(
    ...
    body.extend(
        [
            ...
            f'<footer>本頁面為示範網頁，內容經過亂數處理。實體判讀由 Codex 輔助完成。資料來源：Harvard University, Academia Sinica, and Peking University, <a href="https://projects.iq.harvard.edu/cbdb" target="_blank" rel="noreferrer">China Biographical Database (CBDB)</a>（共 {len(authority_table)} 筆實體）。</footer>',
